...
**Feature: ai-game-platform, Property 14: 定期清理机制**
...
from main import store, GameServerStore


class TestPeriodicCleanup:
    """Property-based tests for periodic cleanup mechanism (Property 14)"""
    ...
    def test_property_14_periodic_cleanup(self, active_count, stale_count):
        """
        **Feature: ai-game-platform, Property 14: 定期清理机制**
        **Validates: Requirements 5.1, 5.2**
